...
<body>
	...
	<div class="news-container">
		<div class="row">
			<h1 class="home-title">Personal Ranklist</h1>
								...
								<table class="table table-striped table-hover">
									...
									<tbody>
										<c:forEach items="${ scorelist }" var="sb">
											<tr
												<c:if test="${ thisuser==sb.username }">class="info"</c:if>>
												<td>${ sb.rank }</td>
												<td><a class="text-muted"
													style="text-decoration: none;" href="profile/${ sb.userid }">${ sb.username }</a>&nbsp;&nbsp;
													<img src="images/flags/${ sb.countrycode }.png" data-placement="right" alt="${ sb.countrycode }" title="${ sb.countryname }" /></td>
												<td>
