...
<body>
    ...
    <div class="news-container">
        <div class="row">
            <h1 class="home-title">Team Submissions</h1>
                    ...
                    <fieldset>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title"><strong>All Submissions of ${ currentteam.name }</strong></div>
                            </div>
    		...
    		$.confirm({
    		    ...
    		    confirm: function(){
    		    	...
    		    	$.post('admin/editsubmit',postdata,function(data){
    		    		if (data.err==0) {
    		    			window.location.replace('admin/teamsubmit/${ currentteam.id }');
    		    		} else {
    		    			$.alert({
    		    				title: false,
    		            	    content: data.errmsg,
