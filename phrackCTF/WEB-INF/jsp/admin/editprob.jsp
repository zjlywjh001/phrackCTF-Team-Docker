...
<body>
    ...
    <div class="news-container">
        <div class="row">
            <h1 class="home-title">Edit Challenge</h1>
                ...
                <form:form class="form-horizontal" onsubmit="javascript:return false;">
                    <fieldset>
                        <div class="form-group">
                            <div class="col-lg-12">
                                <h3>Title</h3>
                                <input type="text" class="form-control col-md-6" id="tasktitle" autocomplete="off" data-provide="typeahead" style="width:50%" value="${ thischall.title }">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-12">
                                <h3>Score</h3>
                                <input type="text" class="form-control col-md-6" id="taskscore" autocomplete="off" data-provide="typeahead" style="width:100px" value="${ thischall.score }">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-12">
                                ...
                                <select id="select01" name="cateselector" class="form-control" style="width: 300px">
                            		...
                            		<c:forEach items="${allcates}" var="ct">
                            			<option value="${ct.id}" <c:if test="${ ct.id==thischall.categoryid }">selected</c:if>>${ct.name}</option>
                            		</c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                        	<div class="col-lg-12" id="attachdiv">
                            	...
                            	<a id="file${ att.id }" href="${ att.resindex }" style="text-decoration:none;"><font size="3">${ att.filename }</font>
        						<input type="hidden" name="attachlist" value="${ att.id }" />
        						</a>&nbsp;&nbsp;&nbsp;
        						<a id="filerm${ att.id }" href="javascript:removeattach(${ att.id });" style="text-decoration:none;">
        							<span class="glyphicon glyphicon-remove" style="color:#ff0000;" title="Remove"></span>
        							<br/>
        						</a>
        						</c:forEach>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-12">
                                <h3>FLAG</h3>
                                <input type="text" class="form-control col-md-6" id="flag"  autocomplete="off" data-provide="typeahead" placeholder="Leave it blank if do not want to change">
                            </div>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input name="isexposed" type="checkbox" <c:if test="${ thischall.exposed }">checked="checked"</c:if>><font size="3px"><strong>Exposed</strong></font>
                            </label>
                        </div>
                        <br/>
                        <div class="form-group">
                            <div class="col-lg-12">
                                ...
                                <input type="text" value="<fmt:formatDate value="${ thischall.available }" pattern="yyyy-MM-dd HH:mm"/>" class="form-control form_datetime col-md-6" name="availfrom" data-date-format="yyyy-mm-dd hh:ii">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-12">
                                <h3>Available Until</h3>
                                <input type="text" value="<fmt:formatDate value="${ thischall.invalidate }" pattern="yyyy-MM-dd HH:mm"/>" class="form-control form_datetime col-md-6" name="availuntil" data-date-format="yyyy-mm-dd hh:ii">
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary" onclick="doeditchallenge(${ thischall.id });">Save</button>
                    </fieldset>
                </form:form>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function doeditchallenge(id){
        	...
        	$.post('admin/editprob/'+id,postdata ,function(data){
        		if (data.err==0) {
        			$.alert({
                	    title: false,
                	    content: data.errmsg,
